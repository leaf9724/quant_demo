...
class LSTM_Regression(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, output_size=1, num_layers=2):
        ...
        self.fc = nn.Linear(hidden_size*CD.days_for_train, output_size)
...
class Creat_LSTM_data():
    def __init__(self, object_and_label=["date", "label_month_%2", "label_month_15%",
    ...
    def data_standard(self,data, lable = "label_week_15%", test_size = 0):
        ...
        nan_columns = self.object_and_label
...
def model_test(file_list_test, threshold=0.6, evaul_plot=True):
    ...
    df.to_csv('/home/pc/matrad/leaf/factor/quant_demo/LSTM_demo/result_to_backtest')
