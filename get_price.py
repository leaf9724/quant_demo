...
# def catch_price_data(code_list, 
...
# def catch_profit_data(code_list,data_path="/home/pc/matrad/leaf/factor/daily_data/profit_data"):
#     for i in tqdm(code_list):
#         profit_list = []
#         for year_i in range(2005,2022):
#             for j in range(1,5):
...
# def catch_operation_data(code_list,data_path="/home/pc/matrad/leaf/factor/daily_data/operation_data"):
#     for i in tqdm(code_list):
#         operation_list = []
#         for year_i in range(2005,2022):
#             for j in range(1,5):
...
# def catch_growth_data(code_list,data_path="/home/pc/matrad/leaf/factor/daily_data/growth_data"):
#     for i in tqdm(code_list):
#         growth_list = []
#         for year_i in range(2005,2022):
#             for j in range(1,5):
...
# def catch_balance_data(code_list,data_path="/home/pc/matrad/leaf/factor/daily_data/balance_data"):
#     for i in tqdm(code_list):
#         balance_list = []
#         for year_i in range(2005,2022):
#             for j in range(1,5):
...
# def catch_cash_data(code_list,data_path="/home/pc/matrad/leaf/factor/daily_data/cash_data"):
#     for i in tqdm(code_list):
#         cash_list = []
#         for year_i in range(2005,2022):
#             for j in range(1,5):
...
# def catch_dupont_data(code_list,data_path="/home/pc/matrad/leaf/factor/daily_data/dupont_data"):
#     for i in tqdm(code_list):
#         dupont_list = []
#         for year_i in range(2005,2022):
#             for j in range(1,5):
